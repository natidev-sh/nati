...
const availableUpgrades: Omit<AppUpgrade, "isNeeded">[] = [
  {
    ...
    manualUpgradeUrl: "https://natidev.com/docs/upgrades/select-component",
  },
  {
    id: "capacitor",
    ...
    manualUpgradeUrl: "https://natidev.com/docs/guides/mobile-app#upgrade-your-app",
  },
];
...
async function applyCapacitor({
  ...
  try {
    ...
    await gitCommit({
      path: appPath,
      message: "[nati] add Capacitor for mobile app support",
    });

  ...
  return (
    <>
      <div className="p-4" data-testid="home-chat-input-container">
        <div
          className={`relative flex flex-col space-y-2 rounded-xl glass-surface glass-hover ${
          ...
          <div className="flex items-start space-x-2 ">
            ...
            {isStreaming ? (
              ...
              <button
                ...
                className="px-2 py-2 mt-1 mr-2 rounded-lg glass-surface glass-hover disabled:opacity-50"
                title="Send message"
              >
                <SendIcon size={20} />
              </button>

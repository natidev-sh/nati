...
`;
  ...
  if (uploadComplete) {
    return (
      <Dialog open={isOpen} onOpenChange={handleClose}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle className="glass-contrast-text">Upload Complete</DialogTitle>
          </DialogHeader>
          <div className="py-6 flex flex-col items-center space-y-4 glass-contrast-text">
            <div className="glass-surface p-6 rounded-full">
              <CheckIcon className="h-8 w-8 text-green-600 dark:text-green-400" />
            </div>
            <h3 className="text-lg font-medium">
              Chat Logs Uploaded Successfully
            </h3>
            <div className="glass-surface p-3 rounded flex items-center space-x-2 font-mono text-sm">
              <FileIcon
      ...
      <Dialog open={isOpen} onOpenChange={handleClose}>
        <DialogContent className="max-w-4xl max-h-[80vh] overflow-hidden flex flex-col">
          ...
          <div className="space-y-4 overflow-y-auto flex-grow">
            <div className="border rounded-md p-3 glass-surface">
              <h3 className="font-medium mb-2">Chat Messages</h3>
              <div className="text-sm rounded p-2 max-h-40 overflow-y-auto glass-surface">
            ...
            <div className="border rounded-md p-3 glass-surface">
              ...
              <div className="text-sm rounded p-2 max-h-40 overflow-y-auto font-mono glass-surface">
            ...
            <div className="border rounded-md p-3 glass-surface">
              ...
              <div className="text-sm rounded p-2 max-h-32 overflow-y-auto glass-surface">
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="rounded-2xl glass-surface border ring-1 ring-white/30 dark:ring-white/10 p-5">
        <DialogHeader>
          <DialogTitle className="glass-contrast-text">Need help with nati?</DialogTitle>
        </DialogHeader>
        ...
        <div className="flex flex-col space-y-4 w-full">
          {isDyadProUser ? (
            <div className="flex flex-col space-y-2">
              <Button
                ...
                className="w-full py-5 rounded-xl shadow-sm shadow-primary/10 transition-all hover:shadow-md hover:shadow-primary/15"
              >
                <SparklesIcon className="mr-2 h-5 w-5" /> Chat with Nati help
                bot (Pro)
              </Button>
              <p className="text-sm text-gray-600 dark:text-gray-400 px-2">
                Opens an in-app help chat assistant that searches through nati's
                docs.
              </p>
            </div>
          ) : (
          ...
          <div className="flex flex-col space-y-2">
            <Button
              ...
              className="w-full py-5 rounded-xl glass-surface glass-hover ring-1 ring-white/40 dark:ring-white/10"
            >
              <BugIcon className="mr-2 h-5 w-5" /> {isLoading ? "Preparing Report..." : "Report a Bug"}
            </Button>
            <p className="text-sm text-gray-600 dark:text-gray-400 px-2">
          ...
          <Button
            ...
            className="w-full py-5 rounded-xl glass-surface glass-hover ring-1 ring-white/40 dark:ring-white/10"
          >
            <UploadIcon className="mr-2 h-5 w-5" /> {isUploading ? "Preparing Upload..." : "Upload Chat Session"}
          </Button>
          <p className="text-sm text-gray-600 dark:text-gray-400 px-2">

    ...
    <>
      ...
      <div className="mb-6">
        <div className="flex items-center mb-1">
          {providerLogo && (
            <img src={providerLogo} alt="Provider" className="h-7 w-7 mr-2 rounded-sm" />
          )}
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mr-3 flex items-center">

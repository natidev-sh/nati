...
export function NeonConnector() {
  ...
  if (settings?.neon?.accessToken) {
    return (
      <div className="flex flex-col space-y-4 p-5 md:p-6 glass-surface border shadow-sm rounded-2xl">
        <div className="flex flex-col items-start justify-between">
          <div className="flex items-center justify-between w-full">
            <h2 className="text-lg font-medium pb-1 glass-contrast-text">Neon Database</h2>
            <Button
              variant="outline"
              onClick={() => {
              ...
              className="ml-2 px-2 py-1 h-8 mb-2 glass-button glass-hover glass-active"
          ...
          <p className="text-sm text-gray-700 dark:text-gray-300 pb-3">
    ...
    <div className="flex flex-col space-y-4 p-5 md:p-6 glass-surface border shadow-sm rounded-2xl">
      <div className="flex flex-col items-start justify-between">
        ...
        <div
          ...
          className="w-auto h-10 cursor-pointer flex items-center justify-center px-4 py-2 rounded-md transition-colors font-medium text-sm glass-button glass-hover glass-active text-zinc-900 dark:text-white border"
